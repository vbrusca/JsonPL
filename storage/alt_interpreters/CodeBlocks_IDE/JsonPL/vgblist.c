 ...
 * Arg1: struct vgb_list **lst2(a pointer to a struct pointer allowing for the deletion of the list pointer)
 * Returns: {0 | 1}
 */
...
{
    return del_vgb_entry(lst, (idx + 1));
}
...
{
    return get_vgb_entry(lst, (idx + 1), found);
}
